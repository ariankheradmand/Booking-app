...
function Section_two({data}) {
  return (
    ...
    <div className='w-[285px]'>
      <Image className='absolute right-0' src={"/Learning-Shapes/Rectangle-" + 5 + ".svg"} width={280} height={200}/>
      <h2 className='pr-4 relative text-sm font-extralight mt-8'>{data.d_header}</h2>
